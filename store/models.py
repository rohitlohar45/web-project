...
class grade(models.Model):
    ...
    misc = models.CharField(max_length=120)
    metaln =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalnn =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    ...
    metaln1 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc1 = models.FloatField(null=True, default=0, )
    metaln2 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc2 = models.FloatField(null=True, default=0, )
    metaln3 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc3 = models.FloatField(null=True, default=0, )
    metaln4 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc4 = models.FloatField(null=True, default=0, )
    metaln5 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc5 = models.FloatField(null=True, default=0, )
    metaln6 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc6 = models.FloatField(null=True, default=0, )
    metaln7 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc7 = models.FloatField(null=True, default=0, )
    metaln8 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc8 = models.FloatField(null=True, default=0, )
    metaln9 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc9 = models.FloatField(null=True, default=0, )
    metaln10 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc10 = models.FloatField(null=True, default=0, )
    metaln11 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc11 = models.FloatField(null=True, default=0, )
    metaln12 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc12 = models.FloatField(null=True, default=0, )
    metaln13 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc13 = models.FloatField(null=True, default=0, )
    metaln14 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc14 = models.FloatField(null=True, default=0, )
    metaln15 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc15 = models.FloatField(null=True, default=0, )
    metaln16 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc16 = models.FloatField(null=True, default=0, )
    metaln17 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc17 = models.FloatField(null=True, default=0, )
    metaln18 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc18 = models.FloatField(null=True, default=0, )
    metaln19 =models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc19 = models.FloatField(null=True, default=0, )
    metaln20 = models.CharField(max_length=120, choices=CHOICES, default=SELECT[0], null=True )
    metalc20 = models.FloatField(null=True, default=0, )
    
    costn =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    

    costnn =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc = models.FloatField(null=True, default=0, )
    costcn = models.FloatField(null=True, default=0, )
    costn1 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc1 = models.FloatField(null=True, default=0, )
    costn2 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc2 = models.FloatField(null=True, default=0, )
    costn3 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc3 = models.FloatField(null=True, default=0, )
    costn4 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc4 = models.FloatField(null=True, default=0, )
    costn5 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc5 = models.FloatField(null=True, default=0, )
    costn6 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc6 = models.FloatField(null=True, default=0, )
    costn7 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc7 = models.FloatField(null=True, default=0, )
    costn8 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc8 = models.FloatField(null=True, default=0, )
    costn9 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc9 = models.FloatField(null=True, default=0, )
    costn10 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc10 = models.FloatField(null=True, default=0, )
    costn11 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc11 = models.FloatField(null=True, default=0, )
    costn12 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc12 = models.FloatField(null=True, default=0, )
    costn13 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc13 = models.FloatField(null=True, default=0, )
    costn14 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc14 = models.FloatField(null=True, default=0, )
    costn15 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc15 = models.FloatField(null=True, default=0, )
    costn16 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc16 = models.FloatField(null=True, default=0, )
    costn17 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc17 = models.FloatField(null=True, default=0, )
    costn18 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc18 = models.FloatField(null=True, default=0, )
    costn19 =models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc19 = models.FloatField(null=True, default=0, )
    costn20 = models.CharField(max_length=120, choices=CHOICES1, default=SELECT[0], null=True )
    costc20 = models.FloatField(null=True, default=0, )
    recovery = models.CharField(max_length=120, default=0)
